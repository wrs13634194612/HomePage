package com.example.mepositry.widget.refreshheaderview;
...
import com.example.mepositry.Utils;
...
public class TodayNewsHeader extends LinearLayout implements RefreshHeader {
    ...
    private void initView(Context context) {
        ...
        LinearLayout.LayoutParams lpNewRefresh = new LinearLayout.LayoutParams(Utils.dp2px(25), Utils.dp2px(25));
